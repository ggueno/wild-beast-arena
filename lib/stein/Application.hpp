...
protected:
    ...
    GLfloat getPressedMouseXPos(){ return m_PressedMouseXPos;};
    GLfloat getPressedMouseYPos(){ return m_PressedMouseYPos;};

    glm::vec4 getViewport(){ return glm::vec4(0,0,width,height); };
